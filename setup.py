...
def load_about():
    about = {}
    with io.open(
        os.path.join(HERE, "tutordisable_courseware_mfe", "__about__.py"),
        "rt",
        encoding="utf-8",
    ) as f:
...
setup(
    ...
    description="disable_courseware_mfe plugin for Tutor",
    ...
    entry_points={
        "tutor.plugin.v1": [
            "disable_courseware_mfe = tutordisable_courseware_mfe.plugin"
        ]
    },
    classifiers=[
